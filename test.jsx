                  ...
                  <table style={{width:'100%', border:'1px solid #000'}}>
                                                ...
                                                <tfoot>
                                                    <tr>
                                                        ...
                                                        <td style={{border:"1px solid rgb(0, 0, 0)",textAlign:'center'}}><span className='font-bold' style={tablecss}>{Math.floor(wsub.work_order_sub_length * 100) / 100}</span></td>
                                                        <td style={{border:"1px solid rgb(0, 0, 0)",textAlign:'center'}}><span style={tablecss}></span></td>
                                                        <td style={{border:"1px solid rgb(0, 0, 0)",textAlign:'center'}}><span className='font-bold' style={tablecss}>Half</span></td>
                                                        <td style={{border:"1px solid rgb(0, 0, 0)",textAlign:'center'}}><span style={tablecss}></span></td>
                                                        <td style={{border:"1px solid rgb(0, 0, 0)",textAlign:'center'}}><span style={tablecss}>
                                                            <tr style={{display:'flex',justifyContent:'space-around'}}>
                                                                <td ><span className='font-bold' style={tablecss}>{wsub.work_order_sub_36_h}</span></td>
                                                                <td ><span className='font-bold' style={tablecss}>{wsub.work_order_sub_38_h}</span></td>
                                                                <td ><span className='font-bold' style={tablecss}>{wsub.work_order_sub_40_h}</span></td>
                                                                <td ><span className='font-bold' style={tablecss}>{wsub.work_order_sub_42_h}</span></td>
                                                                <td ><span className='font-bold' style={tablecss}>{wsub.work_order_sub_44_h}</span></td>
                                                                <td ><span className='font-bold' style={tablecss}>{wsub.work_order_sub_46_h}</span></td>
                                                                <td ><span className='font-bold' style={tablecss}>{wsub.work_order_sub_48_h}</span></td>
                                                              <td><span className='font-bold' style={tablecss}>{wsub.work_order_sub_50_h}</span></td>
                                                            </tr></span>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style={{border:"1px solid rgb(0, 0, 0)"}}>
                                                            <tr style={{display:'flex',justifyContent:'space-around'}}>
                                                                <td ><span className='font-bold' style={tablecss}>{wsub.sum_36_pcs}</span></td>
                                                                <td ><span className='font-bold' style={tablecss}>{wsub.sum_38_pcs}</span></td>
                                                                <td ><span className='font-bold' style={tablecss}>{wsub.sum_40_pcs}</span></td>
                                                                <td ><span className='font-bold' style={tablecss}>{wsub.sum_42_pcs}</span></td>
                                                                <td ><span className='font-bold' style={tablecss}>{wsub.sum_44_pcs}</span></td>
                                                                <td ><span className='font-bold' style={tablecss}>{wsub.sum_46_pcs}</span></td>
                                                                <td ><span className='font-bold' style={tablecss}>{wsub.sum_48_pcs}</span></td>
                                                                <td><span className='font-bold' style={tablecss}>{wsub.sum_50_pcs}</span></td>
                                                            </tr>
                                                        </td>
